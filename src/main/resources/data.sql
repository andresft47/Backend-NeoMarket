...
INSERT INTO cliente (id, nombre, apellido, email, telefono, fecha_registro, activo) VALUES
(1,'Juan','Perez','juan.perez@email.com','3001111111','2024-01-15',true),
(2,'Maria','Gomez','maria.gomez@email.com','3002222222','2024-02-20',true),
(3,'Carlos','Ruiz','carlos.ruiz@email.com','3003333333','2024-03-10',true),
(4,'Ana','Martinez','ana.martinez@email.com','3004444444','2024-03-25',true),
(5,'Pedro','Lopez','pedro.lopez@email.com','3005555555','2024-04-05',true),
(6,'Sofia','Torres','sofia.torres@email.com','3006666666','2024-04-18',true),
(7,'Diego','Herrera','diego.herrera@email.com','3007777777','2024-05-01',true),
(8,'Valentina','Castro','vale.castro@email.com','3008888888','2024-05-14',true);
